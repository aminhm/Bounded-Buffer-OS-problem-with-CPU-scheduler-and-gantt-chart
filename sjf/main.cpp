...
void* producer(void *arg) {
    ...
    while (i) {
        ...
        read >> count_;
        string line;
        ifstream myfile("/Users/aminhasanzadehmoghadam/Desktop/q1/process" + count_ + ".txt");
        ...
        if (myfile.is_open()) {
            ...
            if (counter_for_none_cpu_work == _process.size() && counter_for_none_cpu_work != 0) {
                ...
                if (bestChoice.process_number != 0) {
                    works++;
                }
                ...
                ofstream newfile("/Users/aminhasanzadehmoghadam/Desktop/q1/process" + new_file + ".txt");
                stringstream ss;
                stringstream tt;
                stringstream dd;
    ...
    while (flag) {
        ...
        if (out_process.process_number != 0) {
            ...
            if (min_arrival_time >= out_process.arrival_time) {
                if (out_process.process_number != -1) {
            ...
            min_arrival_time = min_arrival_time + out_process.burst_time;
            if (out_process.process_number != -1) {
            ...
            ofstream executes("/Users/aminhasanzadehmoghadam/Desktop/q1/executed" + write_executes + ".txt");
            for (int k = 0; k < len; k++) {
...
int main() {
    ...
    ofstream res("/Users/aminhasanzadehmoghadam/Desktop/q1/result.txt");
    res<<"AWT : "<<awt/works<<'\n';
    res<<"ART : "<<awt/works<<'\n';
    res<<"ATAT : "<<atat/works<<'\n';
